...
This refactoring is the practical form of Bertrand Meyer's Command-Query Separation principle (*Object-Oriented Software Construction*, 1988): a method should either change state or return a result, but not both. When you can trust that queries are side-effect free, you can read code without fear that a glance triggers a change.
</Callout>
