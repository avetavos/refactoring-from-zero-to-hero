...
The metaphor is Kent Beck's, as Martin Fowler records in *Refactoring* (2nd ed., 2018, ch. 2, "The Two Hats"). The rule is simple and strict: wear only one hat at a time. If you are halfway through extracting a function and notice a missing feature, finish the refactor, commit, *then* switch hats. Mixing the two is how a "quick cleanup" turns into an afternoon of debugging — when a test breaks, you can no longer tell whether your restructuring or your new feature caused it.
...
- [Extract Variable](/refactoring/en/composing-methods/extract-variable/)
