...
- [Move Field](/refactoring/en/moving-features/move-field/)
- [Extract Class](/refactoring/en/moving-features/extract-class/)
- [Hide Delegate and Remove Middle Man](/refactoring/en/moving-features/hide-delegate-and-remove-middle-man/)
