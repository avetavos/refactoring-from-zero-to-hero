...
เงื่อนไขที่ชื่อ `monthIsLessThan6OrGreaterThan9` เป็นแค่การอ่านตัวดำเนินการซ้ำอีกรอบ ตั้งชื่อว่า `notSummer` สิ แล้ว `if` จะตอบคำถามเชิงธุรกิจแทน ถ้าวันหลัง logic เรื่องปฏิทินเปลี่ยน ชื่อเดิมก็ยังใช้ได้ มีแค่ body ของ helper ที่ต้องขยับ
</Callout>
...
export const quizDecompose = [
  ...
  },
  {
    ...
    options: [
      'ตัวทำงานเปรียบเทียบที่ใช้',
      'ทำไมสาขาถึงถูกเลือก — คำถามที่กำลังถามอยู่',
      'ตัวแปรที่อ่านเป็นตัวแรก',
      'จำนวนอนุประโยคที่มี',
    ],
    answer: 1,
  },
  ...
  },
  {
    ...
    options: [
      'เมื่อยาวหลายบรรทัด',
      'เมื่อเป็น expression ที่ง่ายเล็กน้อยอยู่แล้วซึ่งชื่อก็ไม่ได้ทำให้กระจ่างขึ้น',
      'เมื่อเรียก function อื่น',
