...
description: ให้แม้แต่ภายใน class เจ้าของเอง ก็อ่านและเขียน field ผ่าน getter กับ setter ของตัวเอง subclass การกำหนดค่าแบบ lazy และการ validate จะได้มีจุดเดียวให้เกาะ
sidebar:
  order: 7
---
...
Encapsulate Variable วางขอบเขตระหว่าง field กับโลก *ภายนอก* ส่วน Self-Encapsulate Field วางขอบเขตเดียวกันนั้นระหว่าง field กับ *ตัว class เอง* — เพื่อให้แม้แต่ method ของเจ้าของเองก็เดินผ่าน accessor ทำให้ subclass และการตรวจสอบความถูกต้องมีรอยต่อให้เกาะเกี่ยว
</Callout>
...
export const quizSelfEncapsulate = [
  {
    ...
    options: [
      'การเรียกเครือข่าย',
      'การอ่านและเขียน field ภายในของ class เจ้าของเอง',
      'test fixture',
      'parameter ของ constructor เท่านั้น',
    ],
    answer: 1,
  },
  {
    ...
    options: [
      'ทำให้ class compile เร็วขึ้น',
      'ให้จุดเดียวแก่คุณสำหรับเพิ่มการตรวจสอบความถูกต้อง การกำหนดค่าแบบ lazy หรือการ override ใน subclass',
      'ลบความจำเป็นในการมี constructor',
      'ลบ field ที่อยู่เบื้องล่างทิ้ง',
    ],
    answer: 1,
  },
  {
    ...
    options: [
      'ตัวแปร global',
      'method accessor ซึ่งมักอยู่หลัง interface หรือ trait ที่ type ห่อหุ้มสามารถ re-implement ได้',
      'การ panic ใน getter',
