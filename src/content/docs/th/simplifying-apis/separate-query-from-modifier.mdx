...
การรีแฟกเตอร์นี้คือรูปแบบเชิงปฏิบัติของหลักการ Command-Query Separation ของ Bertrand Meyer (*Object-Oriented Software Construction*, 1988): method หนึ่งควรเปลี่ยนสถานะหรือคืนผลลัพธ์อย่างใดอย่างหนึ่ง แต่ไม่ใช่ทั้งสองอย่าง เมื่อคุณเชื่อใจได้ว่า query ปราศจากผลข้างเคียง คุณก็อ่าน code ได้โดยไม่ต้องกลัวว่าการเหลือบมองจะไปกระตุ้นการเปลี่ยนแปลง
</Callout>
