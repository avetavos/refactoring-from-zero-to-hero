...
inheritance มัดคุณไว้กับ interface *ทั้งชุด* ของ superclass รวมถึงทุกการเปลี่ยนแปลงในอนาคต ส่วน composition ให้คุณส่งต่อเฉพาะสิ่งที่ตั้งใจจะรองรับ ถ้าไม่แน่ใจ ให้ถือ collaborator ไว้เป็น field แล้ว delegate เอา Go กับ Rust อบคำแนะนำนี้ไว้ในตัวภาษาแล้ว เพราะไม่มี inheritance ให้ใช้ผิด คุณจึงหยิบ delegation มาใช้โดยปริยาย และความสัมพันธ์ก็ซื่อตรงเสมอ
</Callout>
