...
description: subclass ที่ต่างกันตามแกนเดียวกลายเป็น class เดียวที่ถือ strategy object ซึ่งสลับเปลี่ยนได้
sidebar:
  order: 5
---
...
export const quizReplaceSub = [
  ...
  },
  {
    ...
    options: [
      ...
      'ไม่ถือ state ใด ๆ',
      'หลีกเลี่ยงการเรียก method ทั้งหมด',
    ],
    answer: 1,
  },
  {
